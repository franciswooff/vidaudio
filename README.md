...
**n.b. INSTRUCTIONS BELOW ARE NOT UPDATED TO MATCH NEW FEATURES ADDED END OF JULY 2022** They are all correct, but need additions to cover the new features. It is hoped to update these instrutions by late August 2022. In the meantime the "EDITME.txt" file specified below contains sufficient information to understand the new features.
